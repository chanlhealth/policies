# Chanl HIPAA Compliance Policies

HIPAA compliance is complicated, but it doesn't have to be. Chanl helps relieve the technical burden with our HIPAA-compliant cloud computing platform and solutions for healthcare.
...
2. When ready, download the policies and comb through for mentions of Chanl or our business and change to appropriate references to your company.
3. Publish your policies in a publicly available location. The files are markdown, so you may need to convert to HTML if you don't have a publishing platform capable of markdown format. You can either create an index page linking to each individual policy, or create a single page listing all the policies in line, [much like we did](https://policy.Chanl.com).

## Who is behind this?

[Chanl](htts://Chanl.com), healthcare's trusted HTRUST CSF Certified digital health platform.

We help companies who handle PHI, both business associates and covered entities, maintain compliance with our ([Compliant Cloud](https://Chanl.com/compliant-cloud)) and ([Managed Integration](https://Chanl.com)).

To get in touch, shoot us an email at [hello@Chanl.com](mailto:hello@Chanl.com). We'd love to hear from you!
...
* [Chanl HIPAA Business Associate Agreement (“BAA”)](source/sections/23-Chanl_hipaa_business_associate_agreement.md)
* [HIPAA Mappings to Chanl Controls](source/sections/24-hipaa_mapping_to_Chanl_controls.md)
